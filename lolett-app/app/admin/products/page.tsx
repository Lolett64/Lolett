      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="font-[family-name:var(--font-montserrat)] font-medium text-[#1a1510] truncate">{product.name}</div>
            <div className="text-xs text-[#1a1510]/40 truncate">{product.slug}</div>
          </div>
        </div>
      </td>
      <td className="px-4 py-3 hidden md:table-cell capitalize text-[#1a1510]/60">
        {product.gender}
      </td>
      ...
      <td className="px-4 py-3">
        <div className="flex items-center justify-end gap-2">
          <Link href={`/admin/products/${product.id}/edit`}>
            <Button variant="ghost" size="sm" className="gap-1 h-8 px-2 text-[#1a1510]/60 hover:text-[#B89547]">
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-[family-name:var(--font-newsreader)] text-3xl font-light text-[#1a1510]">Produits</h2>
          <p className="text-sm text-[#B89547]/70 mt-1">{products.length} produit(s)</p>
        </div>
        <Link href="/admin/products/new">
          <Button className="gap-2 bg-[#1B0B94] text-white hover:bg-[#1B0B94]/90 rounded-lg">
      ...
      {products.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[#B89547]/30 p-12 text-center">
          <p className="text-[#B89547]/60">Aucun produit trouvé</p>
        </div>
      ) : (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="border-b border-gray-200/50 bg-[#FDF5E6]">
                    <tr>
                      <th className="text-left px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50">Nom</th>
                      <th className="text-left px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50 hidden md:table-cell">Genre</th>
                      <th className="text-right px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50">Prix</th>
                      <th className="text-center px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50">Stock</th>
                      <th className="text-center px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50 hidden sm:table-cell">Statut</th>
                      <th className="text-right px-4 py-3 font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-wider text-[#1a1510]/50">Actions</th>
                    </tr>
                  </thead>
...
function TableSkeleton() {
  return (
    <div className="flex flex-col gap-6">
      <div className="h-10 w-48 rounded bg-[#B89547]/10 animate-pulse" />

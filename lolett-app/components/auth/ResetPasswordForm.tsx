          ...
          {validLink === false ? (
            <div className="text-center">
              ...
              <Link
                ...
                className="inline-block text-[#1B0B94] hover:text-[#B89547] font-body text-sm underline"
              >
                Demander un nouveau lien
              </Link>
            </div>
          ) : validLink === null ? (
            <p className="text-center text-sm text-[#5a4d3e] font-body">Vérification en cours…</p>
          ) : (
            <>
              {error && (

        ...
        <div className="bg-[#FEFAF3] rounded-2xl p-8 shadow-sm border border-[#c4b49c]/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <Link href="/mot-de-passe-oublie" className="text-xs text-[#1B0B94] hover:text-[#b3933d] font-body transition-colors">
                Mot de passe oublie ?
              </Link>
            </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 rounded-lg border border-[#1B0B94] text-[#1B0B94] hover:bg-[#1B0B94]/5 font-body text-sm tracking-wide transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
          ...
          <p className="text-center mt-6 text-sm text-[#5a4d3e] font-body">
            ...
            <Link href="/inscription" className="text-[#1B0B94] hover:text-[#b3933d] transition-colors font-medium">
              Creer un compte
            </Link>
          </p>
        </div>

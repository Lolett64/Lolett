...
interface MediterraneeSectionProps {
  content?: Record<string, string>;
}

export function MediterraneeSection({ content }: MediterraneeSectionProps) {
  return (
        ...
        <div className="mb-16 text-center">
          ...
          <ScrollReveal>
            <p className="mx-auto mt-6 max-w-[50ch] text-lg leading-relaxed text-white/60">
              {content?.mediterranee_text || "Le soleil, les matières naturelles, l'art de vivre simplement bien. C'est ça, notre ADN."}
            </p>
          </ScrollReveal>
        </div>

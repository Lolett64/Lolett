  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 sm:pt-44 sm:pb-28">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-0 left-1/2 h-full w-px -translate-x-1/2 bg-[#1B0B94]/[0.08]" />
      </div>
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        <p className="text-[10px] font-medium tracking-wider uppercase text-[#130970]">Notre Histoire</p>
        <h1 className="font-display mt-6 text-6xl font-bold leading-tight tracking-tight text-[#1e1610] sm:text-7xl lg:text-8xl">
          LOLETT
        </h1>
        <div className="mx-auto mt-6 h-px w-16 bg-gradient-to-r from-transparent via-[#1B0B94] to-transparent" />

...
<head>
  ...
  <title>Commande expédiée — LOLETT</title>
        ...
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width: 520px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 12px;">
              <p style="margin: 0; font-size: 10px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.25em; color: #C4956A;">Commande expédiée</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" style="padding-bottom: 16px;">
              <p style="margin: 0; font-size: 13px; color: #B5A99A; line-height: 1.6;">
                ${overrides?.body_text || 'Votre commande a été expédiée et arrivera sous 24 à 48h.'}
              </p>
            </td>
          </tr>
          <tr>
